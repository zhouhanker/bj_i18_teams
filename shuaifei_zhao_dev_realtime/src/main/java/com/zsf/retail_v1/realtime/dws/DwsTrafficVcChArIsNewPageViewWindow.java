...
import com.zsf.retail_v1.realtime.bean.TrafficPageViewBean;
...
/**
 * &#064;Package  com.zsf.retail.v1.realtime.dws.DwsTrafficVcChArIsNewPageViewWindow
 * &#064;Author  zhao.shuai.fei
 * &#064;Date  2025/4/15 10:06
...
// 最大并发检查点数
        ...
        //读取日志中的数据
        DataStreamSource<String> kafkaStrDS = KafkaUtil.getKafkaSource(env, "dwd_traffic_page", "kafka001");
