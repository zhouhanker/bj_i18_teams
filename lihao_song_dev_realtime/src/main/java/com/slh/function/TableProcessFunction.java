...
/**
 * @Package com.lzy.v1.function.TableProcessFunction
 * @Author lihao.song
 * @Date 2025/4/11 9:03
 * @description:
 */
...
public class TableProcessFunction extends BroadcastProcessFunction<JSONObject, TableProcessDim, Tuple2<JSONObject,TableProcessDim>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        List<TableProcessDim> tableProcessDimList = JdbcUtil.queryList(mySQLConnection, "select * from dev_realtime_v1_config.table_process_dim", TableProcessDim.class, true);
