...
import com.ytx.bean.DimJoinFunction;
...
public abstract class DimAsyncFunction<T> extends RichAsyncFunction<T, T> implements DimJoinFunction<T> {
    ...
    public abstract void addDims(TradeSkuOrderBean orderBean, JSONObject dimJsonObj);

    public abstract String getTableName();

    public abstract String getRowKey(TradeSkuOrderBean orderBean);
