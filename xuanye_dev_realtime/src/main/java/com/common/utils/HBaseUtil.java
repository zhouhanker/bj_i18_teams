    ...
    public static void createHBaseTable(Connection hbaseConn, String namespace, String tableName, String... families) {
        ...
        try (Admin admin = hbaseConn.getAdmin()) {
            ...
            for (String family : families) {
                ColumnFamilyDescriptor columnFamilyDescriptor = (ColumnFamilyDescriptor) ColumnFamilyDescriptorBuilder.newBuilder(Bytes.toBytes(family)).build();
                tableDescriptorBuilder.setColumnFamily((org.apache.hadoop.hbase.client.ColumnFamilyDescriptor) columnFamilyDescriptor);
            }
