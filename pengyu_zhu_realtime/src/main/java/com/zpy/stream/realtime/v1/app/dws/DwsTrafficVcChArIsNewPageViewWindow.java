...
import com.zpy.bean.TrafficVcChArIsNewPageViewBean;
...
/**
 * @Package com.zpy.app.dws.DwsTrafficVcChArIsNewPageViewWindow
 * @Author pengyu_zhu
 * @Date 2025/4/21 9:37
...
public class DwsTrafficVcChArIsNewPageViewWindow {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = FlinkSourceUtil.getKafkaSource("dwd_traffic_page_pengyu_zhu", "dws_traffic_vc_ch_ar_is_new_page_view_window");
