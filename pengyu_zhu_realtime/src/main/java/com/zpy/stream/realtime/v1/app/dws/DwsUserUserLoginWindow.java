...
import com.zpy.bean.UserLoginBean;
...
/**
 * @Package com.zpy.app.dws.DwsUserUserLoginWindow
 * @Author pengyu_zhu
 * @Date 2025/4/21 9:56
...
public class DwsUserUserLoginWindow {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = FlinkSourceUtil.getKafkaSource("dwd_traffic_page_pengyu_zhu", "dws_user_user_login_window");
