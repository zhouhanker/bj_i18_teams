...
/**
 * @Package com.cj.realtime.dwd.BaseDbTableProcessFunction
 * @Author chen.jian
...
public class BaseDbTableProcessFunction extends BroadcastProcessFunction<JSONObject, TableProcessDwd, Tuple2<JSONObject, TableProcessDwd>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        List<TableProcessDwd> tableProcessDwdList
                = JdbcUtil.queryList(mySQLConnection, "select * from gmall2025_config.table_process_dwd", TableProcessDwd.class, true);
