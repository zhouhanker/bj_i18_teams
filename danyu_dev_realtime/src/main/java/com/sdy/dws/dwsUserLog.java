...
/**
 * @Package com.sdy.retail.v1.realtime.dws.dwsUserLog
 * @Author danyu-shi
 * @Date 2025/4/16 13:46
 * @description:
 * 独立用户以及回流用户聚合统计
 */
public class dwsUserLog {
    @SneakyThrows
...
// 1. 解析数据, 封装 pojo 中
        DataStreamSource<String> kafkaStrDS = KafkaUtil.getKafkaSource(env, "stream_dwdpage_danyushi", "dws_Home_PageView");
