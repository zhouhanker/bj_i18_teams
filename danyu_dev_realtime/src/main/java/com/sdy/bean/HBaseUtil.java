...
public class HBaseUtil {
     ...
     */
    public static void putRow(Connection conn, String nameSpace, String table, String rowKey, String family, JSONObject data) throws IOException {
        // 1. 获取 table 对象
     ...
     * @throws IOException 可能抛出的异常
     */
    public static void delRow(Connection conn, String namespace, String table, String rowKey) throws IOException {
        TableName tableName = TableName.valueOf(namespace, table);
        try(Table t = conn.getTable(tableName)){
