...
//        String pong = jedis.ping("连接成功");
//        System.out.println(pong);
//        closeJedis(jedis);

        StatefulRedisConnection<String, String> redisAsyncConnection = getRedisAsyncConnection();
        closeRedisAsyncConnection(redisAsyncConnection);
    }
}
